...
function Products() {
  const [searchParams, setSearchParams] = useSearchParams({
    // THIS OBJ IS FOR DEFAULT VALUE
    skip: 0,
    limit: 4,
  });
  const limit = parseInt(searchParams.get("limit") || 0); // SEARCH PARAMS RETURN STRING BUT WE WANT INTEGER
  ...
  const { data: products } = useQuery({
    queryKey: ["products", limit, skip, q, category], // NEDD TO MENTION ALL THINGS NECCESARY OTHERWISE IT WILL NOT WORK AS EXPECTED
    queryFn: async () => {
    ...
    placeholderData: keepPreviousData, // USED TO MAKE UX BETTER, NEW DATA DOESNOT RENDER UNTIL IT HAS BEEN DOWNLOADED 100%.
  });
